...
// объ€вление функции расчета поверхости шкафа
...
int main() {
	...
	float PW_Cost = calculatePaintingCost(sizes, consumption, workCost, paintCost);//вычисл€ем полную стоимость покраски шкафа
